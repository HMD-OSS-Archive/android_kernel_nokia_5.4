...
/* Huaqin added for DRSTRANGE-657 add log for debug by wangzikang at 2020/07/13 start */
...
/* Huaqin added for DRSTRANGE-657 add log for debug by wangzikang at 2020/07/13 end */
				  ...
				  const union power_supply_propval *val)
{
	...
	/*Huaqin added for AR-ZQL1838-01-59 add some logs by wangzikang at 2020/05/09 start*/
	pr_info("Input_suspend is %d.\n",val->intval);
	/*Huaqin added for AR-ZQL1838-01-59 add some logs by wangzikang at 2020/05/09 end*/
				...
				const union power_supply_propval *val)
{
	...
	smblib_dbg(chg, PR_MISC, "[%s]line=%d: auto_recharge_vbat_mv=%d, val->intval=%d\n",
