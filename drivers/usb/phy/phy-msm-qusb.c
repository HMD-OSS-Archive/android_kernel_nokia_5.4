...
struct qusb_phy {
	...
	/*ZQL1838 added for DRSTRANGE-98  Separate Host and Device Phy setting by wangzikang at 2020/06/18 start*/
	int			tune2_efuse_correction_host;
	/*ZQL1838 added for DRSTRANGE-98  Separate Host and Device Phy setting by wangzikang at 2020/06/18 end*/
...
/*ZQL1838 added for DRSTRANGE-216  added log for USB_EYE_DIAGRAM by wangzikang at 2020/06/24 start*/
	pr_info("%s():USB_eye_diagram Tune1 = 0x%02x Tune2 = 0x%02x Tune3 = 0x%02x Tune4 = 0x%02x\n",__func__,
	readl_relaxed(qphy->base + QUSB2PHY_PORT_TUNE1),
	readl_relaxed(qphy->base + QUSB2PHY_PORT_TUNE2),
	readl_relaxed(qphy->base + QUSB2PHY_PORT_TUNE3),
	readl_relaxed(qphy->base + QUSB2PHY_PORT_TUNE4));
	/*ZQL1838 added for DRSTRANGE-216  added log for USB_EYE_DIAGRAM by wangzikang at 2020/06/24 end*/
