...
/* Huaqin modify for SR-ZQL1838-01-70 by gaozhengwei at 2020/05/21 start*/
...
/* Huaqin modify for SR-ZQL1838-01-70 by gaozhengwei at 2020/05/21 end*/
				    ...
				    unsigned long brightness)
{
	...
	if (NULL == chosen)
		pr_err("DT: chosen node is not found\n");
	else {
