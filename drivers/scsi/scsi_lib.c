...
void scsi_io_completion(struct scsi_cmnd *cmd, unsigned int good_bytes)
{
	...
	/* ZQL1849 add for DRDOOM-61 Add scsi log by shixaunxuan at 2020/9/22 start */
	#if defined(HQ_FACTORY_BUILD) //factory version
	printk("%s ---> %d \n",__func__,blk_stat);
	#endif
	/* ZQL1849 add for DRDOOM-61 Add scsi log by shixuanxuan at 2020/9/22 end */
	...
	/* ZQL1849 add for DRDOOM-61 Add scsi log by shixuanxuan at 2020/9/16 start */
	#if defined(HQ_FACTORY_BUILD) //factory version
	printk("%s ---> blk_bidi_rq \n",__func__);
	#endif
	/* ZQL1849 add for DRDOOM-61 Add scsi log by shixuanxuan at 2020/9/16 end */
	 ...
	 */
	 /* ZQL1849 add for DRDOOM-61 Add scsi log by shixuanxuan at 2020/9/22 start */
	#if defined(HQ_FACTORY_BUILD) //factory version
