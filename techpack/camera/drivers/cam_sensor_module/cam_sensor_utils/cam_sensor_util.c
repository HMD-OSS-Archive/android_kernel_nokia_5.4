...
#endif
extern char *s5k3l6_sensor_name;
/*zql1838 code for camera bringup by zhangpeng at 2020/5/11 start*/
	...
	for (index = 0; index < ctrl->power_setting_size; index++) {
		...
		case SENSOR_WL2864C_VAF:
			...
			if (power_setting->seq_val < num_vreg) {
				...
				if((0 == strcmp(s5k3l6_sensor_name, "hmd1_s5k3l6_jk"))&&(0 == strcmp(soc_info->rgltr_name[vreg_idx], "cam_wl2864c_vdig")))
					{
					soc_info->rgltr_min_volt[vreg_idx]=1050000;
					CAM_ERR(CAM_SENSOR, "s5k3l6 dvdd volt =%d\n",soc_info->rgltr_min_volt[vreg_idx]);
					}
